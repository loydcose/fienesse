    ...
    <footer className="bg-black/70 text-white">
      <div className="max-w-[1200px] mx-auto px-4 py-12 md:py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          <div>
            <h3 className="font-lato text-lg font-bold mb-4">Informatie</h3>
            <ul className="space-y-2 font-lato text-sm">
              <li>
                <a href="#" className="hover:opacity-70 transition-opacity">
                  Over Maison de Fienesse
                </a>
              </li>
              <li>
                <a href="#" className="hover:opacity-70 transition-opacity">
          ...
          <div>
            <h3 className="font-lato text-lg font-bold mb-4">Behandelingen</h3>
            <ul className="space-y-2 font-lato text-sm">
              <li>
                <a href="#" className="hover:opacity-70 transition-opacity">
                  Laserontharing
          ...
          <div>
            <h3 className="font-lato text-lg font-bold mb-4">Contact</h3>
            <ul className="space-y-2 font-lato text-sm">
              <li>
                <a href="tel:0471337390" className="hover:opacity-70 transition-opacity">
                  041 33 73 90
                </a>
              </li>
              <li>
          ...
          <div>
            <h3 className="font-lato text-lg font-bold mb-4">Socials</h3>
        ...
        <div className="border-t border-white/20 pt-8">
          <div className="text-center font-lato text-xs space-y-2">
            <p>@ 2025 Maison de Fienesse</p>
            <p>Branding, webdesign & ontwikkeling Rose Marketing</p>
            <p>
              <a href="#" className="hover:opacity-70 transition-opacity">
                Privacybeleid
              </a>
